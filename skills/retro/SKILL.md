---
name: retro
description: "Faciliteer een gestructureerde retrospective met je team. Variabel format — kiest automatisch een passende werkvorm op basis van de situatie en teamdynamiek."
triggers:
  - retro
  - retrospective
  - terugblik
...
3. **Sfeer**: Hoe was de afgelopen periode? Goed, zwaar, neutraal, gespannen?
4. **Eerdere retro's**: Hebben jullie eerder retro's gedaan? Wat werkte, wat niet?
5. **Specifieke aandacht**: Is er iets specifieks dat besproken moet worden? (Incident, conflict, groot succes)
6. **Format**: Hebben jullie een voorkeur voor een bepaald format, of mag ik kiezen?
...
**Sterktes:** Simpel, snel, iedereen begrijpt het.
**Zwaktes:** Kan oppervlakkig worden als het team het te vaak doet.
...
**Sterktes:** Stimuleert reflectie op leren, niet alleen op doen.
**Zwaktes:** Kan overlappen (Lacked vs Longed For).
...
**Sterktes:** Visueel, maakt abstracte problemen bespreekbaar, leuk.
**Zwaktes:** Metafoor kan afleiden van concrete issues.
...
**Sterktes:** Maakt emoties bespreekbaar, laagdrempelig.
**Zwaktes:** Kan verzanden in klagen als je niet goed doorvraagt naar oorzaken.
...
**Sterktes:** Maakt patronen zichtbaar, concreet door tijdsgebondenheid.
**Zwaktes:** Kost meer tijd, minimaal 90 minuten.
...
**Sterktes:** Focust op welzijn en duurzaamheid, niet alleen output.
**Zwaktes:** Levert soms acties op die buiten de invloed van het team liggen.
...
1. **Gekozen werkvorm** — met rationale waarom dit format past bij de situatie
2. **Facilitatieplan** — tijdsindeling met alle fasen en exacte tijden
3. **Vragen per fase** — doorvragen die de facilitator kan gebruiken
4. **Actie-template** — tabel voor het vastleggen van acties
5. **Incheckvraag** — passend bij de sfeer
6. **Check vorige acties** — reminder om hiermee te openen
